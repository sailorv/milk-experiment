...
<div style={{height: `100vh`, display: `flex`, alignItems: `center`, width: `100%`}}>
  <section style={{width: `100%`}}>
    <div style={{ margin: `0 auto`, width: `90%`, textAlign: `left`}}>
        ...
        <p style={{ textAlign: `right`, }}> &mdash; <em>Virtual Light</em> by William Gibson<span className="cursor" style={{lineHeight: `1.25`, position: `relative`, top: `6px`, left: `3px`}}></span></p>
    </div>
  </section>
</div>
    )
